                ...
                <div className="container">
                    <div className="row">
                        <div className="meta-details" >
                            ...
                            <p>The information provided by <strong>BlockVerse Technologies Private Limited</strong> (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;) on <strong>https://blockverseacademy.com</strong> (the &ldquo;Site&rdquo;) is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the Site.</p>
                            ...
                            <p>Hence the Disclaimer statement applicable for BlockVerse Technologies are also applicable for BlockVerse Institute.</p>
                            ...
                            <p>While we have made every attempt to ensure that the information contained in this site has been obtained from reliable sources, BlockVerse Technologies Private Limited is not responsible for any errors or omissions or for the results obtained from the use of this information. All information in this site is provided &ldquo;as is&rdquo;, with no guarantee of completeness, accuracy, timeliness or of the results obtained from the use of this information, and without warranty of any kind, express or implied, including, but not limited to warranties of performance, merchantability, and fitness for a particular purpose.</p>
                            <p>In no event will BlockVerse Technologies Private Limited, its related partnerships or corporations, or the partners, agents or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site or for any consequential, special or similar damages, even if advised of the possibility of such damages.</p>
                            <p><strong>LOGOS AND TRADEMARKS DISCLAIMER</strong></p>
                            <p>All logos and trademarks of third parties referenced on https://blockverseacademy.com are the trademarks and logos of their respective owners. Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement or sponsorship of BlockVerse Technologies Private Limited by such owners.</p>
                            <p><strong>CONTACT US</strong></p>
                            <p>Should you have any feedback, comments, requests for technical support or other inquiries, please contact us by email: <strong>support@blockverseacademy.com</strong>.</p>
                            <p>&nbsp;</p>
